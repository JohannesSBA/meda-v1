...
import { renewOwnerSubscription } from "@/services/subscriptions";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await renewOwnerSubscription({
    ...
    logger.error("Failed to renew owner subscription", error);
    return NextResponse.json(
