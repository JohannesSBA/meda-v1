...
export default function HeroSection({
  ...
  return (
    <div className="space-y-10 pb-12">
      <section className="relative isolate overflow-hidden rounded-3xl border border-(--color-border) bg-[#081627] px-6 py-12 sm:px-10 lg:px-14">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <span className="inline-flex rounded-full border border-(--color-border-strong) bg-white/5 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-(--color-brand)">
              Meda Football
            </span>
            <h1 className="text-4xl font-extrabold leading-tight text-white sm:text-5xl lg:text-6xl">
              The football community platform where matches become friendships.
            </h1>
            <p className="max-w-2xl text-sm text-[#cfe4fb] sm:text-base">
      ...
      <section className="space-y-4">
        <div className="flex items-end justify-between">
          <h2 className="text-2xl font-bold text-white">Matches near you</h2>
          <Link
            href="/events"
