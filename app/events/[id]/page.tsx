...
export default async function EventDetailPage({
  ...
  return (
    <main className="min-h-screen min-w-screen overflow-y-auto bg-[#061224 ] text-white -z-10 mt-16 absolute top-0">
      ...
      <div className="relative mx-auto overflow-scroll flex max-w-6xl flex-col gap-8 px-6 py-10">
          ...
          <div className="space-y-6 rounded-3xl border border-white/6 bg-[#0d1a27]/80 p-6 shadow-2xl shadow-[#00e5ff12] backdrop-blur">
            ...
            <article className="space-y-4 text-[#c5d7ec]">
              ...
              <div className="grid gap-3 text-sm text-[#9fc4e4] sm:grid-cols-2">
                <div className="rounded-xl border border-white/10 bg-[#0f1f2d] px-4 py-3">
              ...
              {event.occurrences && event.occurrences.length > 1 ? (
                <div className="rounded-xl border border-white/10 bg-[#0f1f2d] px-4 py-3 text-sm text-[#9fc4e4]">
